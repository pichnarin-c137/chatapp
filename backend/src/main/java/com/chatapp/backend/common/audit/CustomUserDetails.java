...
public class CustomUserDetails implements UserDetails {
    ...
    @Override public boolean isAccountNonLocked()       { return user.getStatus() != com.chatapp.backend.user.UserStatus.BANNED; }
    @Override public boolean isCredentialsNonExpired()  { return true; }
    @Override public boolean isEnabled()                { return user.getStatus() == com.chatapp.backend.user.UserStatus.ACTIVE
